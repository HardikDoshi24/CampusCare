  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data) {
        ...
        const [namelogin, emaillogin] = response.data.split(", "); // Split the data into name and email
        handleLogin(namelogin, emaillogin);  // Pass user information to handleLogin
